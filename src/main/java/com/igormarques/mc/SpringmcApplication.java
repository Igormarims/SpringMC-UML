...
import com.igormarques.mc.domain.ItemPedido;
...
import com.igormarques.mc.repositories.ItemPedidoRepository;
...
public class SpringmcApplication implements CommandLineRunner {
	...
	@Autowired
	private ItemPedidoRepository itemPResi;
	...
	public void run(String... args) throws Exception {
		...
		itemPResi.saveAll(Arrays.asList(ip1,ip2,ip3));
